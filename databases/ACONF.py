...
TAGL['%s-%s-reagent'    % (dbse, 'B_G'                   )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'B_T'                   )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_ggg'                 )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_gptpgm'              )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_gpxmgm'              )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_gpxmtp'              )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_gtg'                 )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_gtt'                 )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_tgg'                 )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_tgt'                 )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_tpgpxm'              )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_ttt'                 )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_xpgmgm'              )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'H_xpgmxp'              )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'P_GG'                  )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'P_GX'                  )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'P_TG'                  )] = """ """
TAGL['%s-%s-reagent'    % (dbse, 'P_TT'                  )] = """ """
