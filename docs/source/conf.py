...
sys.path.insert(0, os.path.abspath('../../databases/'))
sys.path.insert(0, os.path.abspath('../../'))
sys.path.insert(0, os.path.abspath('./'))
...
latex_documents = [
  ('index', 'qcdb.tex', u'qcdb Documentation',
   u'Lori A. Burns', 'manual'),
]
...
man_pages = [
    ('index', 'qcdb', u'qcdb Documentation',
     [u'Lori A. Burns'], 1)
]
...
texinfo_documents = [
  ('index', 'qcdb', u'qcdb Documentation',
   u'Lori A. Burns', 'qcdb', 'One line description of project.',
   'Miscellaneous'),
]
