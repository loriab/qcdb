...
#        options['CFOUR']['CFOUR_CHARGE']['has_changed'] = True
#        options['CFOUR']['CFOUR_MULTIPLICITY']['has_changed'] = True
#        options['CFOUR']['CFOUR_UNITS']['has_changed'] = True
#        options['CFOUR']['CFOUR_COORDINATES']['has_changed'] = True
