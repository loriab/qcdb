...
optclue2psivar = {
    'full': ['CCSD CORRELATION ENERGY',
               'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY',
               'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSDT(Q) TOTAL ENERGY'],
    'fno1e3': ['CCSD CORRELATION ENERGY',
               'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSD(T) FNO CORRELATION ENERGY', 'FNO CORRECTION ENERGY',
               'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSDT(Q) TOTAL ENERGY'],
    'fno1e4': ['CCSD CORRELATION ENERGY',
               'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSD(T) FNO CORRELATION ENERGY', 'FNO CORRECTION ENERGY',
               'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSDT(Q) TOTAL ENERGY'],
    'fno5e5': ['CCSD CORRELATION ENERGY',
               'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSD(T) FNO CORRELATION ENERGY', 'FNO CORRECTION ENERGY',
               'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSDT(Q) TOTAL ENERGY'],
    'fno1e5': ['CCSD CORRELATION ENERGY',
               'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSD(T) FNO CORRELATION ENERGY', 'FNO CORRECTION ENERGY',
               'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSDT(Q) TOTAL ENERGY'],
    'fno1e6': ['CCSD CORRELATION ENERGY',
               'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSD(T) FNO CORRELATION ENERGY', 'FNO CORRECTION ENERGY',
               'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSDT(Q) TOTAL ENERGY'],
